...
func _on_Ingame_History_Button_pressed():
	...
	# 2. O PULO DO GATO: Se o jogo estiver pausado, despausa temporariamente 
	# para o scroll do mouse funcionar na tela de história!
	get_tree().paused = false
	
	# 3. Abre a tela de história nativa do Dialogic
